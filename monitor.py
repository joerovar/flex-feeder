...
headways_sg = np.load('out/params/headways SG.npy', allow_pickle=True)
headways_sg = headways_sg[()]
headways_rl = np.load('out/params/headways PQL peak.npy', allow_pickle=True)
headways_rl = headways_rl[()]
results.plot_2hw_cv(headways_sg, headways_rl, 'out/figs/headway comparison spaced.png', lbls, clrs)
...
headways_rl_OP = np.load('out/params/headways PQL off peak.npy', allow_pickle=True)
headways_rl_OP = headways_rl_OP[()]
results.plot_2hw_cv(headways_rl, headways_rl_OP,'out/figs/OP headway comparison spaced.png', lbls_OP, clrs_OP)
